...
//        isPermissionGranted(it, mPermission)
    ...
    fun requestPermission(permission: Array<String>): Boolean {
        val isGranted = (ContextCompat.checkSelfPermission(this, permission[0]) == PackageManager.PERMISSION_GRANTED)
...
//            mPermission = permission
    ...
    open fun isPermissionGranted(isGranted: Boolean, permission: String?) {
        if(isGranted){
            Log.e("isPermissionGranted", "$permission")
        }
    }
