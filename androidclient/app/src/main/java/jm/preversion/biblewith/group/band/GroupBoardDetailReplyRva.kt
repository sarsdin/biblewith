...
import jm.preversion.biblewith.databinding.GroupBoardDetailReplyListVhBinding
...
class GroupBoardDetailReplyRva (val groupVm: GroupVm, /*val images : JsonArray,*/ val groupBoardDetail: GroupBoardDetail)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GroupBoardDetailReplyRvaVh {
...
//        super.getItemViewType(position)
    ...
    override fun onBindViewHolder(holder: GroupBoardDetailReplyRvaVh, position: Int) {
