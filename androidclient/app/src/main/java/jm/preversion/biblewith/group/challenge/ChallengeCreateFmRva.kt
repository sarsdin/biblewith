...
import jm.preversion.biblewith.databinding.ChallengeCreateFmVhBinding
...
class ChallengeCreateFmRva(val groupVm: GroupVm, val bibleVm: BibleVm, val challengeCreateFm: ChallengeCreateFm)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChallengeCreateFmVh {
...
//            val iv: ImageView = findViewById(jm.preversion.biblewith.R.id.iv) as ImageView
