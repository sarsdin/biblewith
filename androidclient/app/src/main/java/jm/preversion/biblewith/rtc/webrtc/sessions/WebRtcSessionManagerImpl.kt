...
import jm.preversion.biblewith.rtc.MediaProjectionService
import jm.preversion.biblewith.rtc.RtcFm
import jm.preversion.biblewith.rtc.webrtc.SignalingClient
import jm.preversion.biblewith.rtc.webrtc.SignalingCommand
import jm.preversion.biblewith.rtc.webrtc.audio.AudioHandler
import jm.preversion.biblewith.rtc.webrtc.audio.AudioSwitchHandler
import jm.preversion.biblewith.rtc.webrtc.peer.StreamPeerConnection
import jm.preversion.biblewith.rtc.webrtc.peer.StreamPeerConnectionFactory
import jm.preversion.biblewith.rtc.webrtc.peer.StreamPeerType
...
//    }
     ...
     */
    fun reCreateLocalVideoTrack(): VideoTrack {
        ...
        sessionManagerScope.launch {
            ...
            signalingClient.signalingCommandFlow.collect { pair ->
                ...
                when (pair.first) {
                    ...
                    // 이때, 이곳 A는 B와 C의 peerId를 확인하여 해당 아이디로
                    // 이미 생성된 peerConnection 객체가 있는지 map에서 먼저 확인해야함.
