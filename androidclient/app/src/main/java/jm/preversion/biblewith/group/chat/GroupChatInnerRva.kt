...
import jm.preversion.biblewith.databinding.GroupChatInnerFmVhBinding
import jm.preversion.biblewith.databinding.GroupChatInnerFmVhConnNotiBinding
import jm.preversion.biblewith.databinding.GroupChatInnerFmVhLeftBinding
...
class GroupChatInnerRva(val groupVm: GroupVm, val groupChatInnerFm: GroupChatInnerFm) : RecyclerView.Adapter<GroupChatInnerRva.GroupChatInnerFmVh>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GroupChatInnerFmVh {
    ...
    override fun onBindViewHolder(holder: GroupChatInnerFmVh, position: Int) {
