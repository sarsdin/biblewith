...
class GroupBoardDetailImageRva (val groupVm: GroupVm, /*val images : JsonArray,*/ val groupBoardDetail: GroupBoardDetail) 
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GroupBoardDetailImageRva.GroupBoardDetailImageRvaVh {
    ...
    override fun onBindViewHolder(holder: GroupBoardDetailImageRva.GroupBoardDetailImageRvaVh, position: Int) {
